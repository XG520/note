...
~~~ shell
parameters {choice(choices:'Windows\nLinux',description:'Which platform?',name:'platform')}
~~~
...
- equals expected 字符判断

~~~shell
when {equals expected: '666666',actual: PASSWORD} //当PASSWORD为666666时执行，顺序不能反
~~~
