...
cat > /data/game_server/target/10000/app/Configs/server_config.json << EOF
{
  ...
  "dataCenter":"gosu_yn",
  "sdkType": 1,
  "mongoDB": "gosu_yn_game_hz_10000",
  "mongoUrl": "mongodb://192.168.1.200:6666/?authSource=admin",
  "cdkUrl": "http://192.168.1.217:5000/history/logic?command=get_cdk&key={0}&roleId={1}&serverId={2}",
  "language": "chinese",
  "mongoGlobalDB": "gosu_yn_game_hz",
