...
cat > /data/game_server/target/10000/app/Configs/server_config.json << EOF
{
  ...
  "dataCenter":"moya_bm",
  "sdkType": 1,
  "mongoDB": "moya_bm_game_hz_10000",
  "mongoUrl": "mongodb://192.168.1.200:6666/?authSource=admin",
  "cdkUrl": "http://192.168.1.219:5000/history/logic?command=get_cdk&key={0}&roleId={1}&serverId={2}",
  "language": "chinese",
  "mongoGlobalDB": "moya_bm_game_hz",
  "configCenterUrl": "http://192.168.1.200:8500/",
  "restoreFromFile": false,
  "localIp": "192.168.1.219"
}
EOF
